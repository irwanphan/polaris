...
/// Schema migrations are declared via [migration]; bump
/// [schemaVersion] whenever a table or column is added/changed and
/// append a handler to `onUpgrade`.
@DriftDatabase(
  tables: <Type>[EventsTable, LifeProfilesTable, NotificationSchedulesTable],
  daos: <Type>[EventsDao, LifeProfilesDao, NotificationsDao],
)
